...
# --- Appendix A: how to detect this dedup as part of routine integrity checks
appendix_a <- c(
  "",
...
# --- Appendix B: intervention-level context (the four Norwegian-1987 events)
appendix_b <- c(
  "",
...
writeLines(c(as.character(md), footer, appendix_a, appendix_b),
