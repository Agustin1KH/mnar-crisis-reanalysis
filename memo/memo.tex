...
\title{Missing-Data Sensitivity of the INCOME Effect\\
       {\large A re-analysis of Metrick and Schmelzing (2024, NBER w29281)}}
...
therefore that the paper's INCOME log-odds lie inside the no-assumption
Manski bounds on all six outcomes but are systematically larger in
magnitude than both the MICE-MAR and MICE-MNAR pooled estimates.
